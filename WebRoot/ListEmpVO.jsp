        	...
        	getContent:function(data,JSONtype){  
        	    if(JSONtype=='table'){
        	        for(i=0;i<(pageMaxRow-pageMinRow+1);i++){
                    	...
                    	$('.action',$('#tb tr:eq('+(i+1)+')')).html('<i class=\'fa fa-trash-o delete pointer\' data-crudtype=\"del\" data-delurl=\"Paging/delete.do\" data-jsontype=\"table\" data-delparam=[\"id\",\".emp_id\"] data-crudsetting=\'{\"loading\":\".ajax_loading\",\"refresh\":\"#refresh\",\"firstpage\":\"#first\",\"lastpage\":\"#last\",\"prevpage\":\"#previous\",\"nextpage\":\"#next\",\"setpagesize\":\".set_page_size\",\"pagesize\":\"#page_size\",\"pageno\":\"#page_no\",\"pagerow\":\"#pageRow\",\"tablename\":\"#tb\"}\'></i>\&nbsp;<i class=\'fa fa-pencil fa-fw update pointer\' data-reveal-id=\'uf\' data-animation=\'fade\' data-dismissmodalclass=\'close-update-frame\' data-crudtype=\"pre-update\" data-preupdateurl=\"Paging/preupdate.do\" data-updateparam=[\"id\",\".emp_id\"] data-crudsetting=\'{\"loading\":\".ajax_loading\"}\' ></i>');           
                	}
                	$().crudListener();
                	$().revealListener();
        	    }
