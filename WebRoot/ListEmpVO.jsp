...
<html>
  ...
  <body>
    <div id="container">
     	  ...
     	  <tr>
		    ...
		    <td class="FULL_NAME" data-column="db"></td>
     	    ...
     	    <td class="ACTION" data-column="normal">
     	      <i class="fa fa-trash-o delete pointer" data-crudtype="del" data-delurl="delete.do" data-jsontype="table" data-delparam=["id",".EMP_ID"] data-crudsetting='{"loading":".ajax_loading","refresh":"#refresh","firstpage":"#first","lastpage":"#last","prevpage":"#previous","nextpage":"#next","setpagesize":".set_page_size","pagesize":"#page_size","pageno":"#page_no","pagerow":"#pageRow","delmsg":".FULL_NAME","tablename":"#tb"}'></i>
     	      <i class="fa fa-pencil fa-fw update pointer" data-reveal-id="uf" data-dismissmodalclass="close-update-frame" data-crudtype="pre-update" data-preupdateurl="preupdate.do" data-updateparam=["id",".EMP_ID"] data-crudsetting='{"loading":".ajax_loading"}'></i>
     	    </td>
         ...
         <div class="content">
           <ul>
             ...
             <li><a class="pointer">显示行数</a>
               <ul>
                 <li>
                   <a class="set_page_size pointer" data-pagetype="setpagesize"  data-queryurl="page.do" data-jsontype="table" data-pagesetting='{"loading":".ajax_loading","firstpage":"#first","lastpage":"#last","prevpage":"#previous","nextpage":"#next","setpagesize":".set_page_size","closebutton":".close-setting","pagesize":"#page_size","pageno":"#page_no","pagerow":"#pageRow","tablename":"#tb"}'>
     ...
     <div id='uf' class='update_frame'>     
       ...
       <div class='content'>
         <form id='updateData'>
           ...
           <label for='eno' class='left'>工号</label>
     ...
     <input type="hidden" id="order_para" value="EMP_ID ASC">  
    ...
    <script type="text/javascript" src="js/jQuery.rowdefine.js"></script>
